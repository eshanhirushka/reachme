        ...
        <div className='bg-secondaryColor p-3 flex flex-0.7 w-full'>
          ...
          {!imageAsset ? (
            ...
            <div className='relative h-full'>
              ...
              <button
                type='button'
                className='absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shadow-md trasition-all duration-500 ease-in-out'
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
          ...
          <div className='flex flex-col'>
            <div>
              ...
              className="outline-none w-4/5 text-base border-b-2 border-gray-200 p02 rounded-md cursor-pointer"
              >
